...
(function($) {
    ...
    function init(givenOptions) {
        ...
        var $fileTabButton = $imageupload.find('.card-header .btn:eq(0)');
        ...
        var $urlTabButton = $imageupload.find('.card-header .btn:eq(1)');
    ...
    function showFileTab($fileTab) {
        ...
        if (!$fileTabButton.hasClass('active')) {
            ...
            $imageupload.find('.card-header .btn:eq(1)').removeClass('active');
    ...
    function showUrlTab($urlTab) {
        ...
        if (!$urlTabButton.hasClass('active')) {
            ...
            $imageupload.find('.card-header .btn:eq(0)').removeClass('active');
